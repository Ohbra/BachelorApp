...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\brian\\BachelorApp\\bachelor-app\\src\\app\\backend\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "805cf5cf9e1f1cdacff2705cd4d3fd70119839a3f10f30db81093be7c2c55a73",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/app/backend/node_modules/.prisma/client",
...
path.join(process.cwd(), "src/app/backend/node_modules/.prisma/client/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/app/backend/node_modules/.prisma/client/libquery_engine-rhel-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/app/backend/node_modules/.prisma/client/schema.prisma")
